...
def matrix_operation(matrix_a, matrix_b, operation):
    ...
    check_matrices_compatible_with_operation(matrix_a, matrix_b, operation)
...
def check_matrices_compatible_with_operation(matrix_a, matrix_b, operation):
    ...
    if (operation == "*" and nb_col_matrix_a != nb_row_matrix_b):
        raise ValueError("Matrices not suited for multiplications")
          ...
          (nb_row_matrix_a != nb_row_matrix_b or
           nb_col_matrix_a != nb_col_matrix_b)):
...
def run_test_matrix_size():
    ...
    matrix = [[1, 2], [3, 4]]
    test_matrix_size("size of matrix 2x2", matrix, (2, 2))

    matrix = [[11, 12, 13]]
    test_matrix_size("size of matrix 1x3", matrix, (1, 3))

    matrix = [[11, 12, 13], [21, 22, 23]]
    test_matrix_size("size of matrix 2x3", matrix, (2, 3))
    ...
    try:
        matrix = [11]
        test_matrix_size("size of matrix 1x1", matrix, (1, 1))
...
def run_test_matrix_addition_substraction():
    ...
    test_matrix_addition_substraction("2x2 matrix addition/substraction",
                                   matrix_a, matrix_b,
                                   expected_a_plus_b, expected_a_minus_b)
    ...
    test_matrix_addition_substraction("4x4 matrix addition/substraction",
                                   matrix_a, matrix_b,
                                   expected_a_plus_b, expected_a_minus_b)


def run_test_matrix_by_vector_multiplication():
...
run_test_matrix_addition_substraction()
run_test_matrix_by_vector_multiplication()
run_test_matrix_by_matrix_multiplication()
